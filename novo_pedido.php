...
<head>
    ...
    <title>Sistema de Doação de Alimentos - Novo Pedido</title>
            ...
            <div class="col-md-8">
                <div class="card shadow-sm">
                    <div class="card-header">
                        <h2 class="h4 mb-0">Criar Novo Pedido de Doação</h2>
                    </div>
                    <div class="card-body">
                        <form action="novo_pedido_action.php" method="POST">
                            <div class="mb-3">
                                <label for="titulo" class="form-label">Título do Pedido:</label>
                                <input type="text" class="form-control" id="titulo" name="titulo" placeholder="Ex: Itens de higiene pessoal" required>
                            </div>
                            <div class="mb-3">
                                <label for="descricao" class="form-label">Descrição Detalhada:</label>
                                <textarea class="form-control" id="descricao" name="descricao" rows="3" placeholder="Descreva os itens que você precisa."></textarea>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="quantidade" name="quantidade" placeholder="Ex: 5 kits, 10 unidades" required>
                                </div>
                            </div>
